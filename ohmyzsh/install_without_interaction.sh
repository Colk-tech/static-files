...
#
# This script is a custom script to install 'oh-my-zsh' without any interactions arranged by Colk-tech.
# This script is based on tools/install.sh of the commit 02d07f3e3dba0d50b1d907a8062bbaca18f88478.
# ( https://github.com/ohmyzsh/ohmyzsh/blob/master/tools/install.sh )
# The original license of 'oh-my-zsh' is MIT License.
# See the entire text of license: https://github.com/ohmyzsh/ohmyzsh/blob/master/LICENSE.txt
#
